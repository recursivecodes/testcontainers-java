...
public class ImagePullPolicyTest {
    ...
    @ClassRule
    public static GenericContainer<?> registry = new GenericContainer(DockerImageName.of("registry:2"))
    ...
    public void pullsByDefault() {
        try (
            GenericContainer<?> container = new GenericContainer(DockerImageName.of(imageName))
